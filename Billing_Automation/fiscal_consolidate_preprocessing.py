...
def date_change():
    ...
    fiscal_dict={'Jan':{1:list(range(25,32)),2:list(range(1,22))},
                 ...
                 'Mar':{1:list(range(19,29)),2:list(range(1,32))}}
    date_mon_1=fiscal_dict['Mar'][1]
    date_mon_2=fiscal_dict['Mar'][2]
...
def fiscal_efforts(df,week,col_name,pos):
    #(df[date_columns] == 'Y').sum(axis=1) + (df[date_columns] == 'Working from Mexico').sum(axis=1)
