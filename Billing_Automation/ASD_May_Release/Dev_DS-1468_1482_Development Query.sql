...
and c.BenefitId__c is not null and aa.BenefitId__c is not null
...
inner join #advisor1 ad on c.BenefitId__c = ad.PrimaryAdvisorIdentifier
where C.RecordTypeId in ('012600000009BHyAAM')
and c.BenefitId__c is not null and A.BenefitId__c is not null and f.IsLatestOffer__c = 'TRUE'