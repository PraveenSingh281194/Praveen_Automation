...
def csv_to_ssms_db():
    ...
    try:
        ...
        if validation_input=='1':
            ...
            report_gen(df_diff,'src//reports//data_diff.csv',file_type='csv')
            print('mismatches exists in 2 datasets') if len(df_diff.index)>0 else print('No mismatches in 2 datasets')
